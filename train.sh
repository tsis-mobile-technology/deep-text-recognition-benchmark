...
--batch_size 150 --batch_max_length 256 --data_filtering_off --workers 0 \
--num_iter 100000 --valInterval 100 & > /dev/null
--saved_model ./models/TPS-ResNet-BiLSTM-Attn-wild.pth --num_iter 1000 --valInterval 100
...
--batch_size 150 --batch_max_length 256 --data_filtering_off --workers 0 \
--num_iter 100000 --valInterval 100 & > /dev/null
--saved_model ./models/TPS-ResNet-BiLSTM-Attn-wild-word.pth --num_iter 1000 --valInterval 100
...
# case 2 for mac(hm) printed(ocr data)
#python train.py --train_data /home/proidea/jupyter/aihub_study_data/data_lmdb/sentence/train --valid_data /home/proidea/jupyter/aihub_study_data/data_lmdb/sentence/validation  --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction CTC --batch_size 150 --batch_max_length 200 --data_filtering_off --workers 0 --num_iter 10000 --valInterval 100

# case 3 for mac(hm) - 0311 - Text in the wild(goods)
#python train.py --train_data /home/proidea/jupyter/aihub_study_data/data_lmdb/wild/train --valid_data /home/proidea/jupyter/aihub_study_data/data_lmdb/wild/validation  --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction CTC --batch_size 150 --batch_max_length 200 --data_filtering_off --workers 0 --num_iter 2000 --valInterval 100 --saved_model ./saved_models/TPS-ResNet-BiLSTM-CTC-220311/best_accuracy.pth
# case 3 for mac(hm) - 0313 - Text in the wild(good) 에러로 이어서 하
python train.py --train_data /home/proidea/jupyter/aihub_study_data/data_lmdb/wild/train --valid_data /home/proidea/jupyter/aihub_study_data/data_lmdb/wild/validation --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction CTC --batch_size 150 --batch_max_length 200 --data_filtering_off --workers 0 --num_iter 2000 --valInterval 100 --saved_model ./saved_models/TPS-ResNet-BiLSTM-CTC-0313.pth
# while true; do sleep 120; printf ".";done
